...
<html>
    <head>
          ...
          <?php
           ...
           ?>
          <link href="css/propertypagelist.css" rel="stylesheet"/>
    </head>
    <body>
          <?php
        ...
        <div class="Propertylist page-container">
       ...
       <div class="property-card id-1 -<?= $property['id'] ?> row">
           ...
           <div class="property-decs col-md-8">
               <div class="row no-gutters justify-content-between">
                   ...
                   ?>
                    <div class="container-star" title ="<?= $total_rating ?>">
                    <?php  
                    $rating = $total_rating;
                    for ($i=0; $i < 5; $i++){
                        if ($rating>=$i + 0.8){
